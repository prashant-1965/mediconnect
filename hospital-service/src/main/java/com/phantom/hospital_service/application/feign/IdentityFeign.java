...
public interface IdentityFeign {
    ...
    @PatchMapping("/appUser/updateUserStatus")
    String updateUserStatus(@RequestParam Long appUserId, @RequestParam String userStatus);

    @GetMapping("/appUser/checkUserStatusByAppUserId")
    Boolean checkUserStatusByAppUserId(@RequestParam Long appUserId, @RequestParam UserStatus userStatus);
